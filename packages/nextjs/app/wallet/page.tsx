    ...
    <div className="p-6 space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
        ...
        <SummaryCard
          ...
          value={openRegistrationTasks.length}
        />
          ...
          {latestCreatorTask && (
            <>
              <p>
                ...
                {latestCreatorTask.title}
              </p>

              <p>
                <strong>Latest Task ID:</strong>{" "}
                {latestCreatorTask.smartContractId}
              </p>
            </>
          )}
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-6">
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm">
            ...
            <li>
              <strong>Creator Stake:</strong>{" "}
              {task.creatorStake}
            </li>

            <li>
              <strong>Member Stake:</strong>{" "}
              {task.memberStake}
            </li>

            <li>
              <strong>Max Revision:</strong>{" "}
              {task.maxRevision}
            </li>

            <li>
              <strong>Deadline Hours:</strong>{" "}
              {task.deadlineHours}
            </li>
