    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="relative max-w-[1440px] mx-auto px-4 md:px-6 py-8">
        ...
        <div className="mb-8 flex items-start justify-between flex-wrap gap-4">
          ...
          <button onClick={() => {window.location.href = "/taskCreation";}} className="inline-flex items-center gap-2 rounded-2xl bg-indigo-500 hover:bg-indigo-600 px-4 py-2.5 text-sm font-medium transition-colors">
