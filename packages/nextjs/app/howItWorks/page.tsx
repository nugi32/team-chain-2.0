...
import Section, { SectionLabel, SectionSub, SectionTitle } from "@/components/how-it-works/Section";
...
const STEPS = [
  ...
  },
  {
    ...
    detail:
      "Each task shows required reputation, stake, reward, deadline, and team trust score so you can assess fit instantly.",
  },
  {
    number: "03",
...
const FAQS = [
  {
    ...
    a: "Missing a milestone deadline incurs a reputation penalty of 10–20 REP. If you abandon a task after staking, you forfeit 25–80 REP and a portion of your stake goes to the protocol treasury.",
  },
  {
    q: "How are disputes handled?",
    a: "Either party can open a dispute for a $5 fee (refunded if you win). A panel of Platinum-tier arbitrators reviews evidence and votes. Resolution typically takes 48–72 hours.",
  },
  {
    q: "Is my stake safe?",
    a: "Stakes are held in audited escrow smart contracts. They are only released on task completion, returned on cancellation, or partially redistributed on dispute resolution.",
  },
  {
    q: "Can teams post tasks for free?",
    a: "Teams pay a small listing fee (~$1–5) and must lock the reward amount in escrow before a task goes live.",
  },
  {
    q: "How long does reputation take to build?",
    a: "A consistent contributor completing 2–3 mid-level tasks per month can reach Silver tier in roughly 2–3 months and Gold in 6–9 months.",
  },
  {
    q: "What chains are supported?",
    a: "Team Chain currently supports Ethereum mainnet, Arbitrum, Optimism, and Polygon. More chains are planned for Q3 2026.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="relative max-w-[1100px] mx-auto px-4 md:px-6 py-14">
        ...
        <Section>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-400 leading-relaxed text-sm md:text-base mb-10">
              Team Chain is a stake-backed collaboration protocol. Workers and teams commit real value on-chain —
              aligning incentives, enforcing accountability, and rewarding quality with verifiable reputation.
            </p>
        ...
        <Section id="steps">
          <SectionLabel>
            <ChevronRight className="w-3 h-3" /> The Process
          </SectionLabel>
          <SectionTitle>Six steps from zero to reward</SectionTitle>
          <SectionSub>
            Every engagement on Team Chain follows the same accountable, on-chain flow — from first connection to final
            payout.
          </SectionSub>
        ...
        <Section id="charts">
          <SectionLabel>
            <BarChart2 className="w-3 h-3" /> Data & Analytics
          </SectionLabel>
          <SectionTitle>Reputation & rewards by the numbers</SectionTitle>
          <SectionSub>
            Real protocol data shows how consistent contributors grow reputation and how stake compares to reward across
            task categories.
          </SectionSub>
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="rounded-2xl border border-gray-800 bg-gray-900 p-5">
              <div className="mb-4">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Three contributor profiles — casual, consistent, top performer
                </p>
              </div>
            ...
            <div className="rounded-2xl border border-gray-800 bg-gray-900 p-5">
              ...
              <div className="flex items-center gap-4 mt-3">
                {[
                  { color: "#f59e0b", label: "Avg Stake" },
                  { color: "#10b981", label: "Avg Reward" },
                ].map(l => (
                  <div key={l.label} className="flex items-center gap-1.5 text-[10px] text-gray-500">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-gray-800 bg-gray-900 p-5">
              ...
              <div className="flex items-center gap-4 mt-2 flex-wrap justify-center">
                {[
                  { color: "#92400e", label: "Bronze" },
                  { color: "#eab308", label: "Gold" },
                  { color: "#06b6d4", label: "Platinum" },
                ].map(l => (
                  <div key={l.label} className="flex items-center gap-1.5 text-[10px] text-gray-500">
                    <div className="w-2.5 h-0.5 rounded-full" style={{ background: l.color }} />
                    {l.label}
        ...
        <Section id="tiers">
          <SectionLabel>
            <Award className="w-3 h-3" /> Tier System
          </SectionLabel>
          <SectionTitle>Four tiers of on-chain credibility</SectionTitle>
          <SectionSub>
            Your tier determines which tasks you can access, how much you can stake, and what protocol privileges you
            hold.
          </SectionSub>
        ...
        <Section id="reputation">
          <SectionLabel>
            <Shield className="w-3 h-3" /> Reputation System
          </SectionLabel>
          <SectionTitle>What changes your reputation score</SectionTitle>
          <SectionSub>
            Every on-chain action is logged and auditable. Reputation is earned through delivery and lost through
            failure — transparently, every time.
          </SectionSub>
        ...
        <Section id="fees">
          <SectionLabel>
            <Layers className="w-3 h-3" /> Fee Structure
          </SectionLabel>
          <SectionTitle>Transparent on-chain fees</SectionTitle>
          <SectionSub>
            All fees are fixed by the protocol and visible before any action is signed. No hidden costs, no variable
            platform markups.
          </SectionSub>
        ...
        <Section id="faq">
          <SectionLabel>
            <Info className="w-3 h-3" /> FAQ
          </SectionLabel>
          <SectionTitle>Common questions</SectionTitle>
          <SectionSub>Everything you need to know before committing your first stake.</SectionSub>
          ...
          <div className="rounded-3xl border border-indigo-500/30 bg-indigo-500/5 p-10 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-gray-400 max-w-lg mx-auto mb-8">
                Connect your wallet, create your profile, and browse open tasks — all in under 5 minutes. Your first
                milestone is one click away.
              </p>
              <div className="flex items-center justify-center gap-3 flex-wrap">
                <Link
                  href="/createAccount"
                  className="inline-flex items-center gap-2 rounded-2xl bg-indigo-500 hover:bg-indigo-600 px-6 py-3 text-sm font-semibold text-white transition-colors shadow-lg shadow-indigo-500/20"
                >
                  <Wallet className="w-4 h-4" /> Connect & Create Profile
                </Link>
                <Link
                  href="/explore"
                  className="inline-flex items-center gap-2 rounded-2xl border border-gray-700 bg-gray-900 hover:border-gray-600 px-6 py-3 text-sm text-gray-300 transition-colors"
                >
