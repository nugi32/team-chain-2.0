    ...
    <FadeInSection>
      <section className="py-20 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Build Transparent Teams On-Chain</h2>
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link
              href="/howItWorks"
              className="text-sm/6 font-semibold text-white px-4 py-2 rounded-lg border border-white/50"
            >
