          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
                ...
                <Link href="/documentation" className="font-semibold text-indigo-400">
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
                TeamChain is a decentralized collaboration platform where teams can manage projects, share ownership,
                and execute workflows transparently on blockchain.
              </p>
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <Link href="/howItWorks" className="text-sm/6 font-semibold text-white">
