    ...
    <div>
      ...
      <div className="rounded-xl border border-gray-800 bg-gray-900/50 px-4 py-1 mb-6">
        ...
        <Toggle
          ...
          onChange={() => toggle("deadlines")}
          label="Deadline reminders"
          desc="24h and 4h before a task deadline."
        />
        <Toggle
          value={settings.reviews}
          onChange={() => toggle("reviews")}
          label="Review requests"
          desc="When your submission needs approval."
        />
        <Toggle
          value={settings.disputes}
          onChange={() => toggle("disputes")}
          label="Dispute updates"
          desc="Status changes on tasks you're involved in."
        />
        <Toggle
          value={settings.invites}
          onChange={() => toggle("invites")}
          label="Team invitations"
          desc="When a team invites you to join a project."
        />
        <Toggle
          value={settings.payouts}
          onChange={() => toggle("payouts")}
          label="Payout confirmations"
          desc="On-chain reward transfers confirmed."
        />
        ...
        />
        <Toggle
          value={settings.pushBrowser}
          onChange={() => toggle("pushBrowser")}
          label="Browser push"
          desc="Real-time alerts in supported browsers."
        />
        ...
        <Toggle
          ...
          desc="News about new features and protocol changes."
        />
      </div>
